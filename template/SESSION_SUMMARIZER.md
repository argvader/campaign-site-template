# Session Summarizer — {{campaign_name}}

## Task Description

This is the session summarizer for **{{campaign_name}}**, a **{{game_system}}**
campaign ({{genre_tone}}).
...
**{{dm_name}}** is the **Dungeon Master** — not a player, but their voice appears as
...
Tone: **{{genre_tone}}**. Read it before writing so names, places, and lore stay
